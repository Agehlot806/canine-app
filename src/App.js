    ...
    <>
      <BrowserRouter>
        ...
        <Routes>
          ...
          {/* Wholeseller flow  */}
          <Route path='/wholeseller-dashboard' element={<Wholesellerdashboard />} />
          <Route path='/wholeseller-product' element={<Wholesellerproduct />} />
          <Route path='/wholeseller-product-details' element={<WholesellerproductDetails />} />
          <Route path='/wholeseller-add-cart' element={<WholesellerAddCart />} />
          <Route path='/wholeseller-payment-method' element={<WholesellerPaymentMethod />} />
