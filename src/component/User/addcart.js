...
function Addcart() {
    ...
    return (
        <>
                            ...
                            <div className='address'>
                                ...
                                <div className='address-card'>
                                    <Row>
                                        ...
                                        <Col lg={2}>
                                            <Button data-toggle="modal" data-target="#changeadress-model">Change</Button>
                                        </Col>
                                    </Row>
                                </div>
                            </div>
            ...
            {/* Modal */}
            <div className="modal fade editAddress" id="changeadress-model" tabIndex={-1} role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
