...
function Product(props) {
  const meta = {
    title:
      "Canine Products - Transform your pet care routine with our products",
    description:
      "Discover the difference in your pet care experience and watch your canine companion thrive with the excellence that Canin Products bring to your home.",
    canonical: "https://canine.hirectjob.in/",
    meta: {
      charset: "utf-8",
      name: {
        keywords:
          "Canin pet care,Premium dog products,Pet care essentials,Canin dog food,Grooming solutions,Canin pet accessories,Nutrient-rich dog meals,Canin grooming essentials,pet nutrition,Canin pet wellness,Dog health supplements,Canin canine care,pet care,Canin pet treats,Quality dog toys,",
      },
    },
  };
  const { id } = useParams();
  ...
  }, [allproduct, currentPage2, sortOption]);
                        ...
                        <ul className="pagination">
                          <li className="page-item">
                            {paginatedCategories?.length > 0 && (
                              <button
                                className="page-link"
                                onClick={() => goToPage(currentPage2 - 1)}
                          ...
                          <li className="page-item">
                            {paginatedCategories?.length > 0 && (
                              <button
                                className="page-link"
                                onClick={() => goToPage(currentPage2 + 1)}
                                disabled={currentPage2 === pageCount}
                              >
                                Next
                              </button>
                            )}
                            ...
                            <div className="product-deatils-price">
                              {uservariationprice && formattedAmount >= 0 ? (
                                <Row>
                                  ...
                                  <Col lg={4} sm={4} xs={3}>
                                    <h5>{`₹${
                                      isNaN(formattedAmount) * quantity
                                        ? 0
