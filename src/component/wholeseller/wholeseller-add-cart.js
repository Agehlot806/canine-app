...
function WholesellerAddCart() {
    ...
    return (
        <>
                            ...
                            <div className='address'>
                                ...
                                <div className='address-card'>
                                    <Row>
                                        ...
                                        <Col lg={2}>
                                            <Button data-toggle="modal" data-target="#wholesellerchangeaddress-model">Change</Button>
                                        </Col>
                                    </Row>
                                </div>
                            </div>
                                ...
                                <Row className='justify-content-center'>
                                    <Col lg={6}>
                                        ...
                                        <Row>
                                            ...
                                            <Col sm={6}>
                                                <Button><Link to="/wholeseller-payment-method">Pay</Link></Button>
                                            </Col>
                                        </Row>
                                        </div>
                                    </Col>
            ...
            {/* Modal */}
            <div className="modal fade editAddress" id="wholesellerchangeaddress-model" tabIndex={-1} role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
